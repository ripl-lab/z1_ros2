...
def main(args=None):
    ...
    future = node.send_traj_request([
        ...
        # np.array([-0.2, 2.8, -1.2, -1.0, 0.0, 0.0]),
        # np.array([-0.2, 2.8, -1.2, -1.2, 0.0, 0.0]),
        # np.array([-0.2, 2.7, -1.2, -1.2, 0.0, 0.0]),
        # np.array([-0.2, 2.6, -1.2, -1.2, 0.0, 0.0]),
        # np.array([-0.2, 2.5, -1.2, -1.2, 0.0, 0.0]),
        # np.array([-0.2, 2.5, -1.2, -1.1, 0.1, 0.0]),
        # np.array([-0.2, 2.5, -1.2, -1.1, 0.2, 0.0]),
        # np.array([-0.2, 2.5, -1.2, -1.1, 0.3, 0.0]),
        # np.array([-0.2, 2.5, -1.2, -1.1, 0.4, 0.0]),
